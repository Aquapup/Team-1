...
# rc_utils.draw_circle(image, contour_center)    
    ...
    #CROP!!!!!
        ...
        try:
            ...
            elif(counter_lidar_to_next>counter>=counter_turn_to_lidar or rcontour_area>30) and (((s_phase==2) or (s_phase==3))):
                # if the contour is out of view set it to a threshold to view it
