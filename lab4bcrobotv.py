...
def update():
 ...
 #   scan=np.array(scan)
    ...
    # else:
    ### ONE SIDE OF WALL
    Kp=.5 #0.5 -oscilaating
    Kd=0
    #dset=50
    dset=50 #check the unit of l/idar cm? 50 
    sharp_front_distance=50 #20
    straight_speed=0.2
    turn_speed =0.18  #remapvalue=150- dset
    remapvalue= dset # subtract car width?  -10 
    max_dis_gap=150
